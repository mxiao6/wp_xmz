...
<html lang="en">
<head>
<title><?php _e('Insert Youtube','bd'); ?></title>
...
<body  onload="init();">
<form name="youtube" action="#" >
	<div class="panel_wrapper">
        <fieldset style="margin-bottom:10px;padding:10px">
            <legend>Insert Youtube video ID</legend>
            <input data-name="youtubeurl" type="text" data-hex="true" id="youtubeurl" style="width:230px" value="">
        </fieldset>
	</div>
