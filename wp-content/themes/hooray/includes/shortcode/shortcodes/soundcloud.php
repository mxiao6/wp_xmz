...
<html lang="en">
<head>
<title><?php _e('Insert soundcloud','bd'); ?></title>
...
<form name="soundcloud" action="#" >
	<div class="panel_wrapper">
        <fieldset style="margin-bottom:10px;padding:10px">
            <legend>Insert Soundcloud URL</legend>
            <input data-name="soundcloudurl" type="text" data-hex="true" id="soundcloudurl" style="width:230px" value="">
        </fieldset>
	</div>
