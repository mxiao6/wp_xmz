...
{
    background-color: <?php echo bdayh_get_option( 'custom_theme_color' ) ?>;
}
.pagenavi span.pagenavi-current,
.pagenavi a:hover{
    border-color: <?php echo bdayh_get_option( 'custom_theme_color' ) ?>;
}
.comment-reply-link,
...
a:hover
{
    color: <?php echo bdayh_get_option( 'custom_theme_color' ) ?>;
}
<?php } ?>
